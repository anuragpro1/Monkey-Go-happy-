...
function draw() {
  ...
  if(keyDown("space")&&player.y>333&&score<=10){
    player.velocityY = -8;
  }
  if(keyDown("space")&&player.y>330&&score<=20){
    player.velocityY = -8;
  }
  if(keyDown("space")&&player.y>324&&score<=30){
    player.velocityY = -8;
  }
  if(keyDown("space")&&player.y>317&&score<40){
    player.velocityY = -8;
  }
  if(keyDown("space")&&player.y>300&&score>= 40){
    player.velocityY = -8;
  }
...
function obstacles() 
  ...
  if(frameCount%200 ===0){
  var stone = createSprite(350,370,50,45);
